...
(async function(){
    var cenData = await d3.csv("static/data/data.csv").catch(err => console.log(err))
    ...
    // append x axis
    var xAxis = gUnit.append("g")
      .classed("x-axis", true)
      .attr("transform", `translate(0, ${height})`)
      .call(bottomAxis);

    // append y axis
    var yAxis = gUnit.append("g")
      .classed("y-axis", true)
      // .attr("transform")
      .call(leftAxis);

    // append initial circles
    var circlesGroup = gUnit.append("g")
      .selectAll("circle")
      .data(cenData)
      .enter()
      .append("circle")
    ...
    var circlesText = gUnit.append("g")
      .selectAll("text")
      .data(cenData)
      .enter()
      .append("text")
    ...
    var xLabelsGroup = gUnit.append("g")
    ...
    // Create group for three x-axis labels
    var yLabelsGroup = gUnit.append("g")
